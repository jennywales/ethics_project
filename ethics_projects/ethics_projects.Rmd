...
* Joy used a FRS in her project which did not recognize her - only worked when she wore a white mask
...
* This is due to the data sets fed into the FRS - largely white and male

## Problems with Privacy

* Loss of anonymity - government can track you anywhere
...
* This means you have to have consent or a really good reason to use it
* Biometric Information Privacy Act (Illinois) - less restrictive then GDPR
* FSR banned entirely in San Francisco and Oakland
...
BIPA seems like a good compromise to address privacy issues while allowing wider use beyond security
